<header style="background: white" class="header fixed-top clearfix">
    <!--logo start-->
    <div class="brand">
        <a style="text-align: center;" href="index.html" class="logo">
    ...
    <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="w3-animate-zoom dropdown-menu extended tasks-bar">
                    <li>
            ...
            <li id="header_inbox_bar" class="dropdown">
                ...
                <ul class=" w3-animate-zoom dropdown-menu extended inbox">
                    <li>
