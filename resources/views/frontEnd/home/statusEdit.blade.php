            ...
            <div class="">
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-4">
                                        <select name="whoSee" class="form-control" id="whoSee">
                                            <option {{$StatusById->whoSee =='Public' ? 'selected':'' }} value="Public">
                                                Public
                                            </option>
                                            <option {{$StatusById->whoSee =='Friend' ? 'selected':'' }} value="Friend">
                                                Friend
                                            </option>
                                            <option {{$StatusById->whoSee =='OnlyMe' ? 'selected':'' }} value="OnlyMe">
                                                Only me
                                            </option>
                                        </select>
                                    </div>
             ...
             --}} <label>
                                            <img height="150" alt="" width="150"
                                                 src="{{asset($StatusById->upload_photo)}}">
                                        </label><br><br>
                                        ...
                                        <input style=" display: none;" accept="image/*" type="file" name="upload_photo"
                                               id="upload_photo">
